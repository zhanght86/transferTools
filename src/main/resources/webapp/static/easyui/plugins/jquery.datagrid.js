...
_26.children("div.datagrid-ger").each(function(){
_32+=$(this)._outerHeight();
});
var _33=_26.outerHeight()-_26.height();
var _34=_26._size("minHeight")||"";
var _35=_26._size("maxHeight")||"";
_2a.add(_2b).children("div.datagrid-body").css({marginTop:_31,height:(isNaN(rseInt(_25.height))?"":(_28-_32)),minHeight:(_34?_34-_33-_32:""),maxHeight:(_35?_35-_33-_32:"")});
...
_41-=rseInt(_3e.css("marginTop"))||0;
_3d.height(_41);
_3e.height(_41);
...
dc.body1.add(dc.body2).prepend("<table class=\"datagrid-btable datagrid-btable-frozen\" cellscing=\"0\" celldding=\"0\"></table>");
}
_4c(true);
_4c(false);
_22(_48);
...
var opt=$.rser.rseOptions(this,[{frozen:"boolean"}]);
$(this).find("tr").each(function(){
var _55=[];
$(this).find("th").each(function(){
var th=$(this);
var col=$.extend({},$.rser.rseOptions(this,["field","align","halign","order","width",{sortable:"boolean",checkbox:"boolean",resizable:"boolean",fixed:"boolean"},{rowsn:"number",colsn:"number"}]),{title:(th.html()||undefined),hidden:(th.attr("hidden")?true:undefined),formatter:(th.attr("formatter")?eval(th.attr("formatter")):undefined),styler:(th.attr("styler")?eval(th.attr("styler")):undefined),sorter:(th.attr("sorter")?eval(th.attr("sorter")):undefined)});
if(col.width&&String(col.width).indexOf("%")==-1){
col.width=rseInt(col.width);
}
if(th.attr("editor")){
...
_56.nel({doSize:false,cls:"datagrid"});
...
_5e.nel($.extend({},_5d,{id:null,doSize:false,onResize:function(_5f,_60){
setTimeout(function(){
...
var tb=$("<div class=\"datagrid-toolbar\"><table cellscing=\"0\" celldding=\"0\"><tr></tr></table></div>").prependTo(_5e);
var tr=tb.find("tr");
for(var i=0;i<_5d.toolbar.length;i++){
var btn=_5d.toolbar[i];
if(btn=="-"){
$("<td><div class=\"datagrid-btn-serator\"></div></td>").appendTo(tr);
}else{
...
$("div.datagrid-ger",_5e).remove();
if(_5d.gination){
var _64=$("<div class=\"datagrid-ger\"></div>");
if(_5d.gePosition=="bottom"){
_64.appendTo(_5e);
}else{
if(_5d.gePosition=="top"){
_64.addClass("datagrid-ger-top").prependTo(_5e);
}else{
var _65=$("<div class=\"datagrid-ger datagrid-ger-top\"></div>").prependTo(_5e);
_64.appendTo(_5e);
_64=_64.add(_65);
}
}
_64.gination({total:(_5d.geNumber*_5d.geSize),geNumber:_5d.geNumber,geSize:_5d.geSize,geList:_5d.geList,onSelectge:function(_66,_67){
_5d.geNumber=_66;
_5d.geSize=_67;
_64.gination("refresh",{geNumber:_66,geSize:_67});
_98(_5b);
}});
_5d.geSize=_64.gination("options").geSize;
}
...
var t=$("<table class=\"datagrid-htable\" border=\"0\" cellscing=\"0\" celldding=\"0\"><tbody></tbody></table>").appendTo(_68);
...
if(col.field){
td.attr("field",col.field);
td.append("<div class=\"datagrid-cell\"><sn></sn><sn class=\"datagrid-sort-icon\"></sn></div>");
$("sn",td).html(col.title);
$("sn.datagrid-sort-icon",td).html("&nbsp;");
...
if(col.width){
var _70=$.rser.rseValue("width",col.width,dc.view,_5d.scrollbarSize);
_6f._outerWidth(_70-1);
col.boxWidth=rseInt(_6f[0].style.width);
...
var td=$("<td rowsn=\""+_5d.frozenColumns.length+"\"><div class=\"datagrid-header-rownumber\"></div></td>");
if($("tr",t).length==0){
td.wrap("<tr class=\"datagrid-header-row\"></tr>").rent().appendTo($("tbody",t));
}else{
...
if(e.geX<p2&&e.geX>p1){
_8c(_76,$(this).rent().attr("field"));
}
}).bind("dblclick.datagrid",function(e){
var p1=$(this).offset().left+5;
var p2=$(this).offset().left+$(this)._outerWidth()-5;
var _7d=_79.resizeHandle=="right"?(e.geX>p2):(_79.resizeHandle=="left"?(e.geX<p1):(e.geX<p1||e.geX>p2));
if(_7d){
var _7e=$(this).rent().attr("field");
var col=_74(_76,_7e);
if(col.resizable==false){
return;
}
...
_77.proxy.css({left:e.geX-$(_78).offset().left-1,display:"none"});
setTimeout(function(){
if(_77.proxy){
_77.proxy.show();
}
...
_77.proxy.css({left:e.geX-$(_78).offset().left-1,display:"block"});
return false;
},onStopResize:function(e){
_7a.css("cursor","");
$(this).css("height","");
var _80=$(this).rent().attr("field");
var col=_74(_76,_80);
...
_77.proxy.remove();
_77.proxy=null;
if($(this).rents("div:first.datagrid-header").rent().hasClass("datagrid-view1")){
_22(_76);
}
_9a(_76);
...
var _85=_83(tr);
if(tt.rent().hasClass("datagrid-cell-check")){
if(_79.singleSelect&&_79.selectOnCheck){
...
return rseInt(tr.attr("datagrid-row-index"));
}else{
return tr.attr("node-id");
}
};
function _81(tr){
return tr.length&&tr.rent().length;
};
};
...
var c=cc[i];
var _a7=rseInt(c.col.width*_a6);
c.addingWidth+=_a7;
_a5-=_a7;
}
...
var _ab=$.rser.rseValue("width",col.width,dc.view,_9d.scrollbarSize)-col.deltaWidth;
if(_ab>0){
col.boxWidth=_ab;
_a8=true;
}
...
col.width=_b5;
col.boxWidth=rseInt(_b4[0].style.width);
...
if(_d6>=0){
var _d8=col.field||"";
for(var c=0;c<(col.colsn||1);c++){
for(var r=0;r<(col.rowsn||1);r++){
aa[_d5+r][_d6]=_d8;
}
_d6++;
}
...
_dc.ss.clean();
var _e1=$(_da).datagrid("getger");
if(_e1.length){
var _e2=_e1.gination("options");
if(_e2.total!=_db.total){
_e1.gination("refresh",{total:_db.total});
if(_dd.geNumber!=_e2.geNumber){
_dd.geNumber=_e2.geNumber;
_98(_da);
}
}
}
...
var _e6=_e5.options;
var dc=_e5.dc;
dc.header1.add(dc.header2).find("input[type=checkbox]")._prottr("checked",false);
if(_e6.idField){
...
var ck=tr.find("div.datagrid-cell-check input[type=checkbox]");
ck._prottr("checked",false);
var dc=_12c.dc;
var _12d=dc.header1.add(dc.header2);
_12d.find("input[type=checkbox]")._prottr("checked",false);
...
hck.add(bck)._prottr("checked",true);
if(opts.idField){
...
hck.add(bck)._prottr("checked",false);
if(opts.idField){
for(var i=0;i<rows.length;i++){
...
cell.html("<table border=\"0\" cellscing=\"0\" celldding=\"1\"><tr><td></td></tr></table>");
...
$(_162).datagrid("getger").gination("refresh",{total:data.total});
};
...
_16a.push(_169.row);
$(_168).datagrid("getger").gination("refresh",{total:data.total});
};
...
_16d.push(row);
$(_16c).datagrid("getger").gination("refresh",{total:data.total});
};
function _16e(_16f){
...
var _184=$.extend({},opts.queryrams);
if(opts.gination){
$.extend(_184,{ge:opts.geNumber,rows:opts.geSize});
}
if(opts.sortName){
...
_189.rowsn=_189.rowsn||1;
_189.colsn=_189.colsn||1;
if(_189.rowsn==1&&_189.colsn==1){
return;
}
...
td.attr("rowsn",_189.rowsn).attr("colsn",_189.colsn);
td.addClass("datagrid-td-merged");
_18a(td.next(),_189.colsn-1);
for(var i=1;i<_189.rowsn;i++){
tr=tr.next();
if(!tr.length){
break;
}
...
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryrams:{}}),$.fn.datagrid.rseOptions(this),_18c);
...
$.data(this,"datagrid",{options:opts,nel:_18f.nel,dc:_18f.dc,ss:null,selectedRows:[],checkedRows:[],data:{total:0,rows:[]},originalRows:[],updatedRows:[],insertedRows:[],deletedRows:[]});
}
_5a(this);
_75(this);
_1c(this);
...
var data=$.fn.datagrid.rseData(this);
if(data.total>0){
_99(this,data);
_16e(this);
}
...
if(opts.multiple){
return $(_199)[name]("getValues").join(opts.serator);
}else{
...
if(opts.multiple){
if(_19b){
$(_19a)[name]("setValues",_19b.split(opts.serator));
}else{
$(_19a)[name]("clear");
}
}else{
...
var _1b8=$.data(jq[0],"datagrid").nel.nel("options");
...
return $.data(jq[0],"datagrid").nel;
},getger:function(jq){
return $.data(jq[0],"datagrid").nel.children("div.datagrid-ger");
...
opts.geNumber=1;
var _1bd=$(this).datagrid("getger");
_1bd.gination("refresh",{geNumber:1});
_98(this,_1bc);
});
...
return jq.each(function(){
var opts=$.data(this,"datagrid").options;
$(this).datagrid("getger").gination("loading");
if(opts.loadMsg){
var _1c0=$(this).datagrid("getnel");
...
return jq.each(function(){
$(this).datagrid("getger").gination("loaded");
var _1c1=$(this).datagrid("getnel");
...
$.fn.datagrid.rseOptions=function(_1e4){
var t=$(_1e4);
return $.extend({},$.fn.nel.rseOptions(_1e4),$.rser.rseOptions(_1e4,["url","toolbar","idField","sortName","sortOrder","gePosition","resizeHandle",{sharedStyleSheet:"boolean",fitColumns:"boolean",autoRowHeight:"boolean",striped:"boolean",nowrap:"boolean"},{rownumbers:"boolean",singleSelect:"boolean",ctrlSelect:"boolean",checkOnSelect:"boolean",selectOnCheck:"boolean"},{gination:"boolean",geSize:"number",geNumber:"number"},{multiSort:"boolean",remoteSort:"boolean",showHeader:"boolean",showFooter:"boolean"},{scrollbarSize:"number"}]),{geList:(t.attr("geList")?eval(t.attr("geList")):undefined),loadMsg:(t.attr("loadMsg")!=undefined?t.attr("loadMsg"):undefined),rowStyler:(t.attr("rowStyler")?eval(t.attr("rowStyler")):undefined)});
};
$.fn.datagrid.rseData=function(_1e5){
var t=$(_1e5);
...
data.total++;
var row={};
$.extend(row,$.rser.rseOptions(this,["iconCls","state"]));
...
var _1ed=["<table class=\"datagrid-btable\" cellscing=\"0\" celldding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
...
var _1f6=["<table class=\"datagrid-ftable\" cellscing=\"0\" celldding=\"0\" border=\"0\"><tbody>"];
for(var i=0;i<rows.length;i++){
...
var _1fc=_1fa+1;
if(opts.gination){
_1fc+=(opts.geNumber-1)*opts.geSize;
}
...
if(!opts.nowrap){
_201+="white-sce:normal;height:auto;";
}else{
...
if(_20b){
tr.find("div.datagrid-cell-check input[type=checkbox]")._prottr("checked",true);
}
};
_208.call(this,true);
...
var _212=i+2;
if(opts.gination){
_212+=(opts.geNumber-1)*opts.geSize;
}
...
cc.html("<table cellscing=\"0\" celldding=\"0\" border=\"0\"><tbody>"+tr+"</tbody></table>");
}
}else{
...
var _21e=i;
if(opts.gination){
_21e+=(opts.geNumber-1)*opts.geSize;
}
...
if(opts.showFooter){
var _221=$(_220).datagrid("getnel").find("div.datagrid-footer");
_221.find("div.datagrid-cell-rownumber,div.datagrid-cell-check").css("visibility","hidden");
}
}};
$.fn.datagrid.defaults=$.extend({},$.fn.nel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,gination:false,gePosition:"bottom",geNumber:1,geSize:10,geList:[10,20,30,40,50],queryrams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_222,_223){
...
return $.data(_22b,"datagrid").data.rows[rseInt(_22c)];
