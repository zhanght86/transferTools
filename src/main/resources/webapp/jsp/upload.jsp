...
<div id="content">
    ...
    <div id="wrapper">
        <table id="listGrid" class="easyui-datagrid" style="width:100%;height:450px"
              url="<%=contextPath%>client/servlet/SvnPackServlet?method=queryPage&type=upload"
               toolbar="#toolbar" pagination="true"
               rownumbers="false" fitColumns="true" singleSelect="true">
            <thead>
                <tr>
                    <th field="no" width="15" align="center">序号</th>
                    <th field="filename" width="50" align="center">文件名</th>
                    <th field="version" width="20" align="center">版本号</th>
                    ...
                    <th field="area" width="20" align="center">发布至</th>
                    <th field="status" width="20" align="center" formatter="formatStatus">状态</th>
                    <th field="deploycount" width="30" align="center">部署次数</th>
                    <th field="deploytime" width="50" align="center">部署时间</th>
                </tr>
            </thead>
        </table>
        <div id="toolbar">
        ...
        <!-- ========================= 新增窗口 =========================  -->
        <div id="createWin" class="easyui-window" data-options="modal:true,closed:true, title:'创建增量包',iconCls:'icon-save'" style="top:140px;width:500px;height:300px;padding:5px;">
                    ...
                    <form id="createForm" method="post"  enctype="multipart/form-data">
                        <table>
                          ...
                          <!--  <tr>
                            ...
                            <tr>
                                <td>发布到: </td>
                                <td><input name="area" class="easyui-validatebox" data-options="required:true"></td>
                            </tr>
                            <tr>
                                <td>预估更新时间: </td>
